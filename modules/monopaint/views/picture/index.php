    ...
    <div class="gallery-page">
        <div class="row margin-bottom-20">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <a class="thumbnail fancybox-button zoomer box" data-rel="fancybox-button" title="Gallery" href="<?= $picture->getPictureUrl(); ?>">
                ...
                <div class="text-center pading-bottom-5">
                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#AccessModal">
